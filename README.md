...
<details> 
<summary>Приёмка дизайна, коррекция требований от 01.06.2020</summary>
...
<details> <summary> Первичные вводные проектной документации, до этапа подготовки UX/UI.</summary> 
...
# Чистовые интерфейсы и логика экранов мобильного приложения
## Work in progress
...
Экраны назначения: Вход/Регистрация
