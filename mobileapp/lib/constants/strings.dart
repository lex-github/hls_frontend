...
const scheduleDayText = 'Отметьте предполагаемое время тренировки на суточных часах, '
...
const scheduleNightTriviaText1 = 'Дипазан нормы сна для человека от 7 до 9 часов в сутки. '
...
const scheduleNightTriviaText2 = 'Сдвиг времени сна в любую сторону, не соответствующую естественным биологическим ритмам '
